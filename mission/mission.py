...
class Mission():
    def __init__ (self,id,name,mission_type,mission_range,payload):
        self.id = id
        self.name = name
    ...
    #def calculate_cruising_range(self):



class MissionSegment():
    def __init__ (self, id, name, aero_setup):
        self.id = id
        self.name = name
    ...
    def load_aircraft_data(self, aircraft_type):
        ...
        if self.aero_setup == "dirty":
            ...
            self.lift2drag = aircraft_type.clean_lift2drag
            print("Unknown aero_setup. Using clean_lift2drag for segment "+ self.id +"_" + self.name)
...
class Cruise(MissionSegment):
    ...
    def __init__(self, id, name, aero_setup, speed, lenght):
        MissionSegment.__init__(self, id, name, aero_setup)
        self.lenght = lenght
        self.speed = speed
...
class Gradient(MissionSegment):
    ...
    def __init__(self, id, name, aero_setup, speed, climb_gradient, initial_altitude, final_altitude):
        MissionSegment.__init__(self, id, name, aero_setup)
...
class Loitering(MissionSegment):
    ...
    def __init__(self, id, name, aero_setup, endurance):
        MissionSegment.__init__(self, id, name, aero_setup)
...
class Estimated(MissionSegment):
    ...
    def __init__(self, id, name, aero_setup, estimated_weight_fraction):
        MissionSegment.__init__(self, id, name, aero_setup)
...
class Combat(MissionSegment):
    ...
    def __init__(self, id, name, aero_setup, combat_time):
        MissionSegment.__init__(self, id, name, aero_setup)
